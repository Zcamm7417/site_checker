...
from sitechecker.rpchecker.cli import read_user_cli_args, display_check_result
from sitechecker.rpchecker.checker import site_is_online, site_is_online_async
